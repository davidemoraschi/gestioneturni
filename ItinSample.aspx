<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ItinSample.aspx.vb" Inherits="gestioneturni.ItinSample" Culture="it-IT"%>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<P>
				<asp:HyperLink id="HyperLink1" runat="server" NavigateUrl="Inserisci.aspx">Inserire turni</asp:HyperLink></P>
		</form>
	</body>
</HTML>
